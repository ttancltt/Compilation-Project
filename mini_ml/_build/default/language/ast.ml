...
let rec get_free_var = function (*This function returns the list of free variables in an expression*)
...
let get_expr_annotation = function (*This function returns the annotation of an expression*)
  | Cst_i (_, ann)
  | Cst_b (_, ann)
  | Cst_str (_, ann)
  | Cst_func (_, ann)
